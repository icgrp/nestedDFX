...
#
# project_gen.tcl: Tcl script for re-creating project 'F210608_nestedDFX'
#
# Generated by Vivado on Wed Jun 09 10:42:50 EDT 2021
...
#
#    "/home/ylxiao/ws_202/F210608_nestedDFX/F210608_nestedDFX.srcs/sources_1/imports/src/led_dirver.v"
#    "/home/ylxiao/ws_202/F210608_nestedDFX/F210608_nestedDFX.srcs/sources_1/imports/src/"
#    "/home/ylxiao/ws_202/F210608_nestedDFX/F210608_nestedDFX.srcs/constrs_1/imports/src/top_nonDFX.xdc"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
   "../source/hdl/led_dirver.v" \
   "../source/hdl/reconfig_full.v" \
   "../source/xdc/top_nonDFX.xdc" \
  ]
  foreach ifile $files {
...
set orig_proj_dir "[file normalize "$origin_dir/F210608_nestedDFX"]"
...
set files [list \
 [file normalize "${origin_dir}/../source/hdl/led_dirver.v"]\
 [file normalize "${origin_dir}/../source/hdl/reconfig_full.v"]\
]
...
set obj [get_filesets sources_1]
set_property -name "top" -value "flooplan_static_wrapper" -objects $obj
...
set file "[file normalize ${origin_dir}/../source/xdc/top_nonDFX.xdc]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "$proj_dir/${_xil_proj_name_}.srcs/constrs_1/imports/xdc/top_nonDFX.xdc"
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj

# Set 'constrs_1' fileset properties
set obj [get_filesets constrs_1]
set_property -name "target_constrs_file" -value "$proj_dir/${_xil_proj_name_}.srcs/constrs_1/imports/xdc/top_nonDFX.xdc" -objects $obj
set_property -name "target_ucf" -value "$proj_dir/${_xil_proj_name_}.srcs/constrs_1/imports/xdc/top_nonDFX.xdc" -objects $obj
...
if { [get_files led_dirver.v] == "" } {
  import_files -quiet -fileset sources_1 /home/ylxiao/ws_202/F210608_nestedDFX/F210608_nestedDFX.srcs/sources_1/imports/src/led_dirver.v
}
if { [get_files ] == "" } {
  import_files -quiet -fileset sources_1 /home/ylxiao/ws_202/F210608_nestedDFX/F210608_nestedDFX.srcs/sources_1/imports/src/
}


# Proc to create BD flooplan_static
proc cr_bd_flooplan_static { parentCell } {
# The design that will be created by this Tcl proc contains the following 
# module references:
# led_driver, reconfig_inst



  # CHANGE DESIGN NAME HERE
  set design_name flooplan_static
  ...
  # Create instance: reconfig_inst_0, and set properties
  set block_name reconfig_inst
  set block_cell_name reconfig_inst_0
  if { [catch {set reconfig_inst_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $reconfig_inst_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_net -net led_driver_0_led_out [get_bd_ports led_out] [get_bd_pins led_driver_0/led_out]
  connect_bd_net -net proc_sys_reset_0_peripheral_reset [get_bd_pins led_driver_0/rst] [get_bd_pins proc_sys_reset_0/peripheral_reset] [get_bd_pins reconfig_inst_0/rst]
  connect_bd_net -net reconfig_inst_0_lower [get_bd_pins led_driver_0/lower] [get_bd_pins reconfig_inst_0/lower]
  connect_bd_net -net reconfig_inst_0_upper [get_bd_pins led_driver_0/upper] [get_bd_pins reconfig_inst_0/upper]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins led_driver_0/clk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins reconfig_inst_0/gclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"1.77142",
   "Default View_TopLeft":"896,65",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r4  2019-12-20 bk=1.5203 VDI=41 GEI=36 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace portBus led_out -pg 1 -lvl 5 -x 1500 -y 220 -defaultsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 1 -x 280 -y 90 -defaultsOSRD
preplace inst proc_sys_reset_0 -pg 1 -lvl 2 -x 770 -y 120 -defaultsOSRD
preplace inst led_driver_0 -pg 1 -lvl 4 -x 1340 -y 220 -defaultsOSRD
preplace inst reconfig_inst_0 -pg 1 -lvl 3 -x 1070 -y 230 -defaultsOSRD
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 1 1 540 80n
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 1 3 550 20 960J 160 1180
preplace netloc proc_sys_reset_0_peripheral_reset 1 2 2 950 300 1190
preplace netloc reconfig_inst_0_lower 1 3 1 1200 230n
preplace netloc reconfig_inst_0_upper 1 3 1 1180 220n
preplace netloc led_driver_0_led_out 1 4 1 N 220
levelinfo -pg 1 -40 280 770 1070 1340 1500
pagesize -pg 1 -db -bbox -sgen -40 -90 1640 310
"
}
...
# End of cr_bd_flooplan_static()
cr_bd_flooplan_static ""
set_property REGISTERED_WITH_MANAGER "1" [get_files flooplan_static.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files flooplan_static.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse flooplan_static.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../source/hdl/flooplan_static_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse flooplan_static.bd] -top]
...
wait_on_run impl_1
file mkdir ./prj/floorplan_static.vitis
write_hw_platform -fixed -include_bit -force -file ./prj/floorplan_static.vitis/flooplan_static_wrapper.xsa
